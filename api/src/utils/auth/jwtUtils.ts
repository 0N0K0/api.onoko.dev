...
const JWT_SECRET: string | undefined = process.env.JWT_SECRET; // Clé secrète utilisée pour signer les tokens JWT, définie dans les variables d'environnement ou une valeur par défaut pour le développement
